...
public interface IPaymentRepository
{
    ...
    Task<Payment?> GetByBillNoAsync(string billNo, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Payment>> GetUnpaidBillsAsync(CancellationToken cancellationToken = default);
