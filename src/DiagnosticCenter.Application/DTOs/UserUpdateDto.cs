...
public class UserUpdateDto
{
    ...
    /// <summary>
    /// Gets or sets the new password (optional). If provided, the password will be updated.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the password confirmation (required if Password is provided).
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the identifier of the user who is modifying this user account.
    /// </summary>
